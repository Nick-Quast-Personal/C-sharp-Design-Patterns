...
- **[decorator-design-pattern](./decorator-design-pattern/)** - Demonstrates the Decorator pattern with optional game-day package add-ons (VIP, parking, merch) in TypeScript.
